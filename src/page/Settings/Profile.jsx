            ...
            <div className="space-y-6">
              <div className="form-group">
                ...
                <input
                  type="text"
                  name="username"
                  className="w-full rounded-sm p-2 mt-2 bg-white border"
                  id="username"
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  name="contactNo"
                  id="contactNo"
                  className="w-full rounded-sm p-2 bg-white mt-2 border"
              ...
              <div className="flex justify-center">
                <button type="submit" className="mt-2 bg-[#234E6F] px-5 py-3 rounded text-white">
                  Save Changes
                </button>
              </div>
            </div>
              ...
              <div className="form-group">
                ...
                <div className="relative">
                  <input
                    ...
                    id="currentPassword"
                    className="w-full rounded bg-white-sm bg-white p-2 mt-2 border"
              ...
              <div className="form-group">
                ...
                <div className="relative">
                  <input
                    ...
                    name="newPassword"
                    id="newPassword"
                    className="w-full rounded-sm bg-white p-2 mt-2 border"
